        ...
        <div className="container mx-auto px-4 max-w-[1200px]">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {categories.map((category, index) => (
              <div key={index} className="relative group overflow-hidden border border-border">
                <a href={category.link} className="block relative aspect-[1/1.5]">
                  ...
                  <div className="absolute inset-x-0 bottom-0 flex flex-col items-center justify-center pt-8 pb-4">
                    <div className="bg-background/90 w-[85%] py-6 flex flex-col items-center border border-border">
                      <h3 className="text-foreground font-display text-base font-bold uppercase tracking-wider mb-3">
                        {category.title}
                      </h3>
                      <div className="bg-primary text-primary-foreground text-[11px] font-display font-bold uppercase py-2 px-6 tracking-widest transition-colors duration-300 hover:bg-foreground hover:text-background cursor-pointer">
                        VER MAIS
                      </div>
                    </div>
                  </div>
