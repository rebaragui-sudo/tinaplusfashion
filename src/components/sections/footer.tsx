...
const Footer = () => {
  ...
  return (
    <footer className="bg-background text-foreground pt-16 border-t border-border">
      <div className="container mx-auto px-4">
        {/* Instagram Section */}
          <div className="mb-20 text-center">
            ...
            <div className="flex flex-col items-center">
              <div className="bg-secondary p-4 mb-4 rounded-full border border-border">
                <Instagram size={48} className="text-primary" />
              </div>
              <p className="text-xs uppercase tracking-widest text-muted-foreground mb-6">Nosso Instagram</p>
              <a 
                href="https://www.instagram.com/tinaplus" 
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-primary text-primary-foreground px-8 py-3 text-xs font-bold tracking-widest uppercase hover:opacity-90 transition-opacity"
              >
                Ver Perfil
              </a>
            </div>
        ...
        <div className="mb-20 text-center">
          ...
          <div className="flex justify-center">
            <a href="#" className="bg-primary text-primary-foreground p-3 rounded-full hover:bg-foreground hover:text-background transition-colors">
              <Instagram size={24} />
            </a>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-10 border-t border-border mb-10">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-[10px] text-muted-foreground uppercase mt-1">Entrega em todo o país</p>
          </div>
          <div className="flex flex-col items-center text-center">
            <span className="mb-2 text-primary">
            ...
            <p className="text-[10px] text-muted-foreground uppercase mt-1">Cartões de crédito ou à vista</p>
          </div>
          <div className="flex flex-col items-center text-center">
            <span className="mb-2 text-primary">
            ...
            <p className="text-[10px] text-muted-foreground uppercase mt-1">Seus dados sempre protegidos</p>
          </div>
        </div>

        {/* Main Footer Links */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-12 border-t border-border">
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest mb-6 border-b border-primary pb-2 inline-block">Navegação</h4>
            <ul className="space-y-4">
              <li><a href="/" className="text-[11px] uppercase tracking-wider text-muted-foreground hover:text-foreground transition-colors">Início</a></li>
              <li><a href="/produtos" className="text-[11px] uppercase tracking-wider text-muted-foreground hover:text-foreground transition-colors">Produtos</a></li>
              <li><a href="/contato" className="text-[11px] uppercase tracking-wider text-muted-foreground hover:text-foreground transition-colors">Contato</a></li>
              <li><a href="/quem-somos" className="text-[11px] uppercase tracking-wider text-muted-foreground hover:text-foreground transition-colors">Quem Somos</a></li>
              <li><a href="/politicas" className="text-[11px] uppercase tracking-wider text-muted-foreground hover:text-foreground transition-colors">Política de Troca e Devolução</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest mb-6 border-b border-primary pb-2 inline-block">Meios de Pagamento</h4>
            <div className="grid grid-cols-5 gap-2 mb-8">
              {paymentMethods.map((method, idx) => (
                <div key={idx} className="bg-white border border-border p-1 flex items-center justify-center h-[28px] w-[38px]">
                  <Image src={method.src} alt={method.alt} width={30} height={20} className="object-contain" />
                </div>
              ))}
            </div>
            <h4 className="text-xs font-bold uppercase tracking-widest mb-4 border-b border-primary pb-2 inline-block">Formas de Envio</h4>
            <div className="bg-white border border-border p-2 inline-block h-[40px] w-[60px]">
              <Image 
          ...
          <div className="md:col-span-2">
            <h4 className="text-xs font-bold uppercase tracking-widest mb-6 border-b border-primary pb-2 inline-block">Contato</h4>
      ...
      <div className="border-t border-border py-6">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center text-[10px] text-muted-foreground tracking-wider uppercase">
