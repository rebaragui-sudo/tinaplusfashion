  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <a
        ...
        onClick={handleClick}
        className="bg-[#25D366] text-white p-4 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-110 active:scale-95 flex items-center justify-center group"
